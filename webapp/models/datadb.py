...
# Set up Sessions table model
class Sessions(db.Model):
    __tablename__ = 'Sessions'

    # List all required columns, along with type and whether they are a key
    ...
    # Set up initialiser in case of wanting to create new entry
...
# Set up SampleDetails table model
...
# Set up AcceptedGrids table model
...
# Set up GlowDischarges table model
...
# Set up RejectedGrids table model
